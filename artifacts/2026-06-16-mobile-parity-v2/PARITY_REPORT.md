...
### template — ✅ [control] (reparented Panel 4+4b (template/bundle/domain))
- opened: true · still editor-first (no Advanced): true · drawer in DOM: true
- controls: 6 total, 6 enabled
- Player Skin (Idle Only)
         · Apply Template · Skin (body family)
          Wea · Idle / Walk
          Attack
    · Default
          Crossbow Attac · Create ActorVisualProfile

### anim — ✅ [control] (reparented Panel 11 (anim+metadata+jitter))
- opened: true · still editor-first (no Advanced): true · drawer in DOM: true
- controls: 17 total, 9 enabled
- idle
        walk
        attack · Assign Row Category(disabled) · group_1 · Assign Selected Frames(disabled) · Apply Frame Groups to Metadata · Bottom Center
        Bottom Lef · First Selected
        Median (S · Auto Align Selected(disabled) · Auto Align Row(disabled) · 0 · 1 · ←(disabled) · →(disabled) · ↑(disabled) · ↓(disabled) · U2 Calibrate Overlay · U4 Review Semantics

### preview — ✅ [control] (reparented Panel 12+13 (xp-preview+session))
- opened: true · still editor-first (no Advanced): true · drawer in DOM: true
- controls: 4 total, 4 enabled
- Play · Stop · 8 · 0

### test — ✅ [control] (reparented Panel 14 (skin-test-dock))
- opened: true · still editor-first (no Advanced): true · drawer in DOM: true
- controls: 2 total, 2 enabled
- Test This Skin · Upload Skin

### export — ✅ [control] (reparented Panel 16+17 (verification+export))
- opened: true · still editor-first (no Advanced): true · drawer in DOM: true
- controls: 7 total, 5 enabled
- Local XP Sanity (Built-in)
      · 20 · Run Verification · Dry Run · verifyCommandTemplate(disabled) · Launch Desktop XP Tool (Optional(disabled) · Export Authoring Artifact
