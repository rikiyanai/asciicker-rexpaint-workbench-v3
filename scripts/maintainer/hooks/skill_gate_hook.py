...
def main():
    ...
    phases_dir = current_project_root / ".planning" / "phases"
    phase_dir = None
    ...
    skills_dir = current_project_root / ".agents" / "skills"
    missing = []
    ...
    hooks_script = current_project_root / "scripts" / "maintainer" / "install_hooks.py"
